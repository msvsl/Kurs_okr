...
<table id="mycart" align="center" cellspacing="0" cellpadding="0" border="0">
	 ...
	 <p class="total" align="center">Oreder price: <span class="product-price"><?=number_format($_SESSION['total_price'],2);?> $</span></p>
...
if($_SESSION['cart'] && isset($_POST['order']))
{
    ...
    echo "<p align='center' style='color: #fff;'>Your order is accepted! Thank you!</p>";
}
